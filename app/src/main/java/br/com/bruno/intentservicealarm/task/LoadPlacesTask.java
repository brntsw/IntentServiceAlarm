package br.com.bruno.intentservicealarm.task;
...
public class LoadPlacesTask extends AsyncTask<Void, Void, List<Place>> {
    ...
    public LoadPlacesTask(Context context){
        this.context = context;
    }

    protected void onPreExecute(){
        progressDialog = new ProgressDialog(context);
        progressDialog.setMessage("Carregando locais...");
        progressDialog.show();
    }
    ...
    protected List<Place> doInBackground(Void... params) {
        ...
        try {
            ...
            String url = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20local.search%20where%20zip%3D'94085'%20and%20query%3D'pizza'&format=json&diagnostics=true&callback=";
            ...
            if(response.getEntity() != null){
                ...
                int objCount = queryObj.getInt("count");
    ...
    protected void onPostExecute(List<Place> places){
        ...
        PlaceQueryDB.insertPlaces(context, places);

        //**Seta o sharedPreferences
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        prefs.edit().putBoolean("carregou", true).apply();
